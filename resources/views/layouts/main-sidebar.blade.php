	...
	<div class="main-sidemenu">
					...
					<ul class="side-menu">
						<li class="slide">
							<a class="side-menu__item" href="{{route('admin.dashboard')}}"><svg xmlns="http://www.w3.org/2000/svg"
								...
								</svg><span class="side-menu__label">Dashboard</span>
							</a>
						</li>
						<li class="slide">
							<a class="side-menu__item" href="{{route('notification.admin')}}">
								<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"></path><path d="M13.73 21a2 2 0 0 1-3.46 0"></path></svg>
		...
		@elseif (Auth::guard('azubi')->check())
			<ul class="side-menu">
				...
				<li class="slide">
					<a class="side-menu__item" href="{{ route('xmpp.presence.daily.azubi',['azubi',encrypt(auth()->user()->id)]) }}">
		...
		@elseif(Auth::guard(name: 'web')->check())
			<ul class="side-menu">
				<li class="slide">
					<a class="side-menu__item" href="{{ route('mitarbeiter.dashboard') }}"><svg xmlns="http://www.w3.org/2000/svg"
							class="side-menu__icon" viewBox="0 0 24 24">
							<path d="M0 0h24v24H0V0z" fill="none" />
							<path d="M5 5h4v6H5zm10 8h4v6h-4zM5 17h4v2H5zM15 5h4v2h-4z" opacity=".3" />
							<path
				...
				<li class="slide">
					<a class="side-menu__item" href="{{ route('xmpp.presence.daily.mitarbeiter',['mitarbeiter',encrypt(auth()->user()->id)]) }}">
						<svg xmlns="http://www.w3.org/2000/svg" class="side-menu__icon" viewBox="0 0 24 24">
							<path d="M0 0h24v24H0V0z" fill="none" />
							<path
								d="M12 4c-4.42 0-8 3.58-8 8s3.58 8 8 8 8-3.58 8-8-3.58-8-8-8zm3.5 4c.83 0 1.5.67 1.5 1.5s-.67 1.5-1.5 1.5-1.5-.67-1.5-1.5.67-1.5 1.5-1.5zm-7 0c.83 0 1.5.67 1.5 1.5S9.33 11 8.5 11 7 10.33 7 9.5 7.67 8 8.5 8zm3.5 9.5c-2.33 0-4.32-1.45-5.12-3.5h1.67c.7 1.19 1.97 2 3.45 2s2.76-.81 3.45-2h1.67c-.8 2.05-2.79 3.5-5.12 3.5z"
